                                    ...
                                    <tr>
                                        ...
                                        <td class="sorting_1">
                                            <div class="d-flex justify-content-start align-items-center user-name">
                                                ...
                                                <div class="d-flex flex-column">
                                                    <span class="fw-semibold user-name-text">{{ $item->reported_user->first_name }}
                                                        {{ $item->reported_user->last_name }}
                                                </div>
                                            </div>
                                        </td>
                ...
                <div class="modal fade" data-bs-backdrop='static' id="deleteUser" tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
                        <div class="modal-content deleteModal verifymodal">
                            ...
                            <div class="modal-body">
                                <div class="body">After deleting the user the user will not acces the app
                                </div>
                            </div>
                            <hr class="hr">
    ...
    @section('script')
        ...
        <script>
            $('.deleteUser').click(function(e) {
                ...
                console.log(itemId)
                $('#deleteButton1').attr('href', "/dashboard/report/user/delete" + "/" +
                    user_id + "/" + itemId);
