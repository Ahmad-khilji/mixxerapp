...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="/assets/img/favicon/mixxer_logo.png" />
...
<body >
    ...
    <div class="authentication-wrapper authentication-cover authentication-bg" style="background: 
    #EEEAE5 !important">
            ...
            <div class="d-flex col-12 col-lg-6 align-items-center p-sm-5 p-4">
                ...
                <div class="w-px-400 mx-auto p-4">
                    ...
                    <div class="image mb-3 mt-3">
                        ...
                        <img src="/assets/img/mixxer_logo.png" alt="" style="width: 40% !important">
                    ...
                    <form id="" class="mb-3" method="post" action="{{ Request::url() }}">
                        ...
                        <button class="btn d-grid w-100" id="signinButton" onclick="showLoader()" style="background-color: 
                        #7E6C54; color:white !important">
